# DAILY FILE TEMPLATE - GPT V2

Every `days/YYYY-MM-DD.md` generated from this stack should include the following sections.
...
| HRV            | Value in ms                        |
| Body Battery   | Current and wake peak if available |
| Resting HR     | bpm                                |
