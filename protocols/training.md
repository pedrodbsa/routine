...
**Week 1:** rest Mon-Wed, then 3 easy runs of 4-5 km. One light full-body session mid-week only if soreness is low. RPE 5-6.

**Week 2:** resume 3 sessions with conservative hypertrophy loading.
...
- **Phase 2:** use an autoregulated mini-deload only if ACWR, soreness, or sleep markers justify it.
- **Phase 4:** one reduced-load week can coincide with the June benchmark race if fatigue is accumulating.
- **Phase 5:** synchronized deload every 3rd week. Reduce running volume 15-20%, keep one quality session, reduce lifting volume ~35-40%.
- Keep intensity touches; remove junk volume.

## Sleep and Readiness Decision Tree

Apply this before deciding whether to keep, downgrade, or cancel training.
...
- **Body Battery <30:** full rest day regardless of sleep duration.
- **Sleep Score <60 for 2 nights:** skip the next quality session.
- **HRV >15% below 7-day average for 3 days:** take 2 easy days or rest days.
...
Use this when family disruption, illness exposure, or repeated sleep loss makes the normal plan unrealistic for an entire week.
...
- PT sessions count only if loads or a usable effort note are logged.
- Running entries must include distance, pace, avg HR, and RPE.
