...
**Goal:** Maintain muscle mass and strength during race prep phase. Energy prioritized for running.

**Session Types:**

- **1 PT session/week:** Thursday after lunch (legs, PT-selected exercises)
- **2 self-directed/week:** User chooses from templates below
...
## LEG DAY (PT Session or Self-Directed)
...
### Race Prep Phase (Now → March 29, 2026)

**Priority:** Maintain, don't build

- Keep weights stable, don't push for PRs
